...
def build():
    ...
    para(tf, "「リハビリのトレーニングを終えました。"
             "指が少し動きやすくなった気がします。」", size=16, color=RGBColor(0x22, 0x22, 0x22))
    table(s, [
        ["順", "AI", "発言の要旨"],
    ...
    notes(s,
          ...
          "結果がこちらです。1体目は「特に効果を感じたトレーニングはありましたか」と問い返し、"
          "2体目は継続とフィードバックという条件を補い、3体目は具体的な目標設定や日常生活での"
          "挑戦へと話を広げています。3体に同じ質問を投げて答えを並べたのではなく、"
          "前の発言を読んだうえで発言しているので、内容が重複していません。\n"
    ...
    table(s, [
        ...
        ["AI 3体", "約 6.0 〜 6.3 秒", "サーバー処理 7ms ＋ LLM応答待ち（2.0 / 2.9 / 1.1 秒）"],
    ...
    notes(s,
          "定量評価として、応答時間を計測しました。\n"
          "AIが3体の場合で約6秒です。先ほどの動画のログでは、1体目が2.0秒、2体目が2.9秒、"
          "3体目が1.1秒で、合計6.0秒でした。内訳を見ると、自作サーバー側の処理は7ミリ秒で、"
